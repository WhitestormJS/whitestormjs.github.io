...
<blockquote class="section">
  ...
  <table>
    <tr>
      <th>r*x*</th><td>Stable version of WhitestormJS. Almost all known issues fixed.</td>
    </tr>
    <tr>
      <th>r*x*-beta</th><td>Semi-stable version. Not all bugs yet fixed, but functionality (API) is fromed well.</td>
    </tr>
    <tr>
      <th>r*x*-alpha</th><td>Alpha version. Just new API and features test. Bugs are not fixed, but can be used in experimental projects.</td>
    </tr>
  </table>
</blockquote>
